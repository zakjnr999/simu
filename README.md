...
<p align="center">
  ...
  <a href="#typography--design-tokens">Design System</a> •
...
```mermaid
graph LR
    A[Enter Realistic Scenario] --> B[Voice / Text Response]
    B --> C[Adaptive AI Reacts]
    C --> D[Diagnostic Feedback]
    D --> E[Earn XP, Streaks and Badges]
    E --> F[Unlock Journey Milestones]
    F --> A
```
...
### 1. Multi-Modal Interactive Simulation Engine
...
- **Diverse Practice Tracks:**
  ...
  - **Conflict Resolution:** De-escalating heated disagreements, mediating peer friction.
...
If you find this project inspiring or useful as a showcase of clean Flutter architecture and tactile design systems, please consider giving it a star on GitHub.

---

<div align="center">
  <sub>Built with Flutter and Riverpod. Dedicated to helping people speak with confidence.</sub>
</div>
